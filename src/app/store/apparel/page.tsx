    ...
    return (
      <div className="min-h-screen bg-black/20 backdrop-blur-sm flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black text-lg">Loading apparel...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-4xl font-bold text-black">Art and Clothing</h1>
            </div>
      ...
      <div className="container mx-auto px-8 py-12">
        {images.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-3xl font-bold text-black mb-4">No Apparel Available</h2>
            <p className="text-xl text-black/80 mb-8">
              No apparel items have been uploaded to this category yet.
            </p>
            <Link 
              href="/store"
          ...
          <>
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-4">
                Art and Clothing Collection
              </h2>
              <p className="text-xl text-black/80 mb-4">
                Wearable art that lets you express your artistic side
              </p>
              <p className="text-lg text-black/60">
                {images.length} apparel item{images.length !== 1 ? 's' : ''} available
              </p>
            </div>
            ...
            <div className="text-center mt-20 bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
              <h3 className="text-3xl font-bold text-black mb-6">About Our Apparel</h3>
              <p className="text-lg text-black/80 max-w-3xl mx-auto mb-8">
                Our wearable art collection features unique designs printed on high-quality garments. 
                Each piece allows you to carry artistic expression with you wherever you go.
              </p>
              <div className="flex flex-wrap justify-center gap-6 text-sm text-black/60">
                <span>✓ Premium Quality Fabrics</span>
                <span>✓ Durable Art Prints</span>
