  ...
  const loadImages = async () => {
    try {
      ...
      const q = query(
        ...
        where('subcategory', '==', 'original-works')
      );
      ...
      console.error('Error loading original works:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-black/20 backdrop-blur-sm flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black text-lg">Loading original works...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-4xl font-bold text-black">Original Works</h1>
            </div>
      ...
      <div className="container mx-auto px-8 py-12">
        {images.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-3xl font-bold text-black mb-4">No Original Works Available</h2>
            <p className="text-xl text-black/80 mb-8">
              No original works have been uploaded to this category yet.
            </p>
            <Link 
              href="/store"
          ...
          <>
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-black mb-4">
                Original Works Collection
              </h2>
              <p className="text-xl text-black/80 mb-4">
                One-of-a-kind original pieces
              </p>
              <p className="text-lg text-black/60">
                {images.length} original work{images.length !== 1 ? 's' : ''} available
              </p>
            </div>
            ...
            <div className="text-center mt-20 bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
              <h3 className="text-3xl font-bold text-black mb-6">About Original Works</h3>
              <p className="text-lg text-black/80 max-w-3xl mx-auto mb-8">
                Each original work is a unique, one-of-a-kind piece created by the artist. These pieces cannot be replicated 
                and represent the raw creative expression and artistic vision in its purest form.
              </p>
              <div className="flex flex-wrap justify-center gap-6 text-sm text-black/60">
                ...
                <span>✓ Museum Quality Materials</span>
              </div>
            </div>
          </>
        )}
