    ...
    return (
      <div className="min-h-screen bg-black/20 backdrop-blur-sm flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black text-lg">Loading prints...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-4xl font-bold text-black">Prints</h1>
            </div>
      ...
      <div className="container mx-auto px-8 py-12">
        {images.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-3xl font-bold text-black mb-4">No Prints Available</h2>
            <p className="text-xl text-black/80 mb-8">
              No prints have been uploaded to this category yet.
            </p>
            <Link 
              href="/store"
          ...
          <>
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-black/60">
                {images.length} print{images.length !== 1 ? 's' : ''} available
              </p>
            </div>
            ...
            <div className="text-center mt-20 bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
              <h3 className="text-3xl font-bold text-black mb-6">About Our Prints</h3>
              <p className="text-lg text-black/80 max-w-3xl mx-auto mb-8">
                Our prints are high-quality reproductions of original artwork, printed on premium archival paper 
                using museum-grade inks. Each print maintains the integrity and beauty of the original piece.
              </p>
              <div className="flex flex-wrap justify-center gap-6 text-sm text-black/60">
                <span>✓ Museum-Grade Inks</span>
